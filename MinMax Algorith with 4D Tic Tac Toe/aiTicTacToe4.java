...
public class aiTicTacToe4 {
    ...
    public positionTicTacToe myAIAlgorithm(List < positionTicTacToe > board, int player) {
        ...
        // calculate time of the turn and save in ai2TurnTimes 
        //this allows us to see if the avg time for move is under 5 seconds
    ...
    public aiTicTacToe4(int setPlayer) {
        player = setPlayer;
